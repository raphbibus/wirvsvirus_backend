...
class StatsTest extends TestCase {
    ...
    public function testStatsCheckoutTokenNotFromClient() {
        $clientWithoutToken = factory('App\Client')->create(['password' => $this->clientPassword]);
        $clientWithToken = factory('App\Client', 1)->create(['password' => $this->clientPassword])->each(function ($client) {
